...
set CLASSPATH=%APP_HOME%\lib\sandbox.jar;%APP_HOME%\lib\testng-6.9.13.6.jar;%APP_HOME%\lib\jcommander-1.48.jar;%APP_HOME%\lib\ant-1.9.7.jar;%APP_HOME%\lib\bsh-2.0b4.jar;%APP_HOME%\lib\ant-launcher-1.9.7.jar
