...
public class GroupCreationTests {
    ...
    public void testGroupCreation() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("test new");
        ...
        wd.findElement(By.name("group_header")).sendKeys("test new 2");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("test new 3");
